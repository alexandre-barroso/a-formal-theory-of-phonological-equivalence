(* Exact independent Wolfram replay for MAX-G6--MAX-G9 semantic closure. *)

BeginPackage["MaxEntG6G9SemanticClosure`"];

MaxEntG6G9Replay::usage =
  "MaxEntG6G9Replay[] returns exact cross-engine anchors for the MAX-G6--MAX-G9 semantic proof schemas.";
ExportMaxEntG6G9Replay::usage =
  "ExportMaxEntG6G9Replay[path] exports the exact neutral JSON replay record.";
...
MaxEntG6G9Replay[] := Module[
  ...
  <|
    "SchemaVersion" -> "1.0.0",
    "Kernel" -> "MaxEntG6G9SemanticClosure`",
...
ExportMaxEntG6G9Replay[path_String] := Export[path, MaxEntG6G9Replay[], "RawJSON"];
