(* Exact Wolfram calculations for the dissertation's MAX-G1--MAX-G5 results. *)

BeginPackage["MaxEntG1G5Calculations`"];

MaxEntG1G5Results::usage =
  "MaxEntG1G5Results[] returns the exact calculations for MAX-G1--MAX-G5.";
