...
This repository contains the public code and data accompanying my doctoral dissertation, that is hosted [here](https://phd.alexandrebarroso.com) as an interactive experience. It collects the exact calculations, formal
