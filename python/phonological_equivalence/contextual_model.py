...
def _require_inputs(inputs: dict[str, Any], expected: dict[str, Any]) -> None:
    if inputs != expected:
        raise ValueError("Inputs do not match the declared contextual derivation")
...
def _c1_general(inputs: dict[str, Any]) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    _require_inputs(inputs, expected)
